...
export const Login = () => {
    ...
    const loginForm = <LoginForm showHelperText={showHelperText} helperText="Invalid login credentials."
                                 helperTextIcon={<ExclamationCircleIcon/>} usernameLabel="Email"
                                 usernameValue={username} onChangeUsername={handleUsernameChange}
                                 isValidUsername={isValidUsername} passwordLabel="Password" passwordValue={password}
                                 onChangePassword={handlePasswordChange} isValidPassword={isValidPassword}
                                 rememberMeLabel="Keep me logged in for 30 days."
                                 isRememberMeChecked={isRememberMeChecked} onChangeRememberMe={onRememberMeClick}
                                 onLoginButtonClick={onLoginButtonClick} loginButtonLabel="Log in"/>;
    const images = {
    ...
    return <LoginPage footerListVariants={ListVariant.inline} brandImgSrc={redHatLogo} brandImgAlt="Red Hat logo"
                      backgroundImgSrc={images} backgroundImgAlt="Images" footerListItems={listItem}
                      textContent="SaaS applications take advantage of multitenant architecture to isolate customer data. Software upgrades, bug fixes, and other general app maintenance are taken care of by the SaaS provider."
